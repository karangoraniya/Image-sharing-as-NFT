...
export default function Minter({
  ...
  const uploadView = (
    <div>
      It's To Hot Drop It or click below to select.
      <Upload
        name="avatar"
  ...
  const nameField = (
    <Input placeholder="Enter a name for osm Image" onChange={e => {
      setName(e.target.value);
    }}/>
  );

  const descriptionField = (
    <Input.TextArea placeholder="Enter a Detail" onChange={e => {
